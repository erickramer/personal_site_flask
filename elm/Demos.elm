port module Demos exposing (Model, Msg(..), SvgSize, init, initModel, main, newParticle, newParticles, randomAcceleration, randomMass, randomPosition, randomVelocity, subscriptions, svg, svgAttributes, svgElements, update, view)
    ...
    let
        ...
        content =
            Svg.foreignObject
                ...
                [ div [ class "container" ]
                    [ div [ class "row", style "margin-top" "25%", style "position" "relative" ]
                        [ div [ class "one-third column", style "text-align" "center" ]
                            [ a [ href "asteroids" ] [ i [ class "fas fa-rocket fa-10x", style "color" "black" ] [] ] ]
                        , div [ class "one-third column", style "text-align" "center" ]
                            [ a [ href "sentiment" ] [ i [ class "fas fa-smile fa-10x", style "color" "black" ] [] ] ]
                        , div [ class "one-third column", style "text-align" "center" ]
                            [ a [ href "https://eransom.shinyapps.io/financial_planning/" ] [ i [ class "fas fa-chart-line fa-10x", style "color" "black" ] [] ] ]
                        ]
                    ]
                ]
    in
    ( List.map (Particle.toCircle fillColor) model.particles ) ++ [ content ]
