port module Contact exposing (Model, Msg(..), SvgSize, init, initModel, main, newParticle, newParticles, randomAcceleration, randomMass, randomPosition, randomVelocity, subscriptions, svg, svgAttributes, svgElements, update, view)
                ...
                [ div [ class "container" ]
                    [ div [ class "row", style "margin-top" "15%" ]
                        [ div [ class "one-half column", style "text-align" "center" ]
                            [ a [ href "phone" ]
                                [ i [ class "fas fa-phone fa-8x", style "color" "black" ] [] ]
                            ]
                        , div [ class "one-half column", style "text-align" "center" ]
                            [ a [ href "email" ]
                                [ i [ class "fas fa-envelope fa-8x", style "color" "black" ] [] ]
                            ]
                        ]
                    , div [ class "row", style "margin-top" "10%" ]
                        [ div [ class "one-half column", style "text-align" "center" ]
                            [ a [ href "https://twitter.com/eransomk" ]
                                [ i [ class "fab fa-twitter fa-8x", style "color" "black" ] [] ]
                            ]
                        , div [ class "one-half column", style "text-align" "center" ]
                            [ a [ href "https://github.com/erickramer" ]
                                [ i [ class "fab fa-github fa-8x", style "color" "black" ] [] ]
                            ]
                        ]
                    ]
                ]
