...
var $author$project$Demos$Model = F3(
...
var $author$project$Demos$initModel = A3(
	$author$project$Demos$Model,
	A2(
...
var $author$project$Demos$init = function (_v0) {
	return _Utils_Tuple2($author$project$Demos$initModel, $elm$core$Platform$Cmd$none);
};
var $author$project$Demos$NewWindowSize = function (a) {
	return {$: 3, a: a};
};
var $author$project$Demos$OnAnimate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Demos$newWindowSize = _Platform_incomingPort(
	'newWindowSize',
	A2(
...
var $author$project$Demos$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Demos$OnAnimate),
				$author$project$Demos$newWindowSize($author$project$Demos$NewWindowSize)
			]));
};
var $author$project$Demos$NewParticles = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Demos$randomAcceleration = A3(
	$elm$random$Random$map2,
	$author$project$Vector$vector,
	A2($elm$random$Random$float, 0, 0),
	A2($elm$random$Random$float, 0, 0));
var $author$project$Demos$randomMass = function (box) {
	return A2(
...
var $author$project$Demos$randomPosition = function (model) {
	return A3(
		$elm$random$Random$map2,
		$author$project$Vector$vector,
		A2(
...
var $author$project$Demos$randomVelocity = function (model) {
...
var $author$project$Demos$newParticle = function (model) {
	return A4(
		$author$project$Particle$randomParticle,
		$author$project$Demos$randomPosition(model),
		$author$project$Demos$randomVelocity(model),
		$author$project$Demos$randomAcceleration,
		$author$project$Demos$randomMass(model.e));
};
var $author$project$Demos$newParticles = F2(
	function (model, n) {
		return A2(
			$elm$random$Random$list,
			n,
			$author$project$Demos$newParticle(model));
	});
...
var $author$project$Demos$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var dt = msg.a;
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$Demos$NewParticles,
						A2($author$project$Demos$newParticles, model, n)));
			case 1:
				var particles = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Demos$svgAttributes = function (model) {
	return _List_fromArray(
		[
...
var $author$project$Demos$svgElements = function (model) {
	var fillColor = 'black';
	var content = A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('one-third column'),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('asteroids')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fas fa-rocket fa-10x'),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('sentiment')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fas fa-smile fa-10x'),
														A2($elm$html$Html$Attributes$style, 'color', 'black')
													]),
												_List_Nil)
											]))
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('https://eransom.shinyapps.io/financial_planning/')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fas fa-chart-line fa-10x'),
														A2($elm$html$Html$Attributes$style, 'color', 'black')
													]),
												_List_Nil)
											]))
...
var $author$project$Demos$svg = function (model) {
	return A2(
		$elm$svg$Svg$svg,
		$author$project$Demos$svgAttributes(model),
		$author$project$Demos$svgElements(model));
};
var $author$project$Demos$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Demos$svg(model)
			]));
};
var $author$project$Demos$main = $elm$browser$Browser$element(
	{a8: $author$project$Demos$init, bp: $author$project$Demos$subscriptions, bt: $author$project$Demos$update, bu: $author$project$Demos$view});
_Platform_export({'Demos':{'init':$author$project$Demos$main(
