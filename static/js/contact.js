...
{
	if (region.ag.L === region.aq.L)
	{
		return 'on line ' + region.ag.L;
	}
	return 'on lines ' + region.ag.L + ' through ' + region.aq.L;
}
...
var $author$project$Box$Box = F2(
	function (height, width) {
		return {w: height, s: width};
	});
var $author$project$Contact$Model = F3(
	function (box, particles, g) {
		return {e: box, _: g, z: particles};
	});
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Contact$initModel = A3(
	$author$project$Contact$Model,
	A2(
...
var $author$project$Contact$init = function (_v0) {
	return _Utils_Tuple2($author$project$Contact$initModel, $elm$core$Platform$Cmd$none);
};
var $author$project$Contact$NewWindowSize = function (a) {
	return {$: 3, a: a};
};
var $author$project$Contact$OnAnimate = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Contact$newWindowSize = _Platform_incomingPort(
	'newWindowSize',
	A2(
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {ad: oldTime, aK: request, aR: subs};
	});
...
var $author$project$Contact$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Contact$OnAnimate),
				$author$project$Contact$newWindowSize($author$project$Contact$NewWindowSize)
			]));
};
var $author$project$Contact$NewParticles = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Particle$radius = function (p) {
	return $elm$core$Basics$sqrt(p.i);
};
...
var $author$project$Box$bounceX = F2(
	function (box, particle) {
		if (_Utils_cmp(
			$author$project$Vector$x(particle.n) + $author$project$Particle$radius(particle),
			$author$project$Box$max(box.s)) > 0) {
			var newVelocity = _Utils_Tuple2(
				-$elm$core$Basics$abs(
					$author$project$Vector$x(particle.q)),
				$author$project$Vector$y(particle.q));
			var newPosition = _Utils_Tuple2(
				$author$project$Box$max(box.s) - $author$project$Particle$radius(particle),
				$author$project$Vector$y(particle.n));
			return _Utils_update(
				particle,
				{n: newPosition, q: newVelocity});
		} else {
			if (_Utils_cmp(
				$author$project$Vector$x(particle.n) - $author$project$Particle$radius(particle),
				$author$project$Box$min(box.s)) < 0) {
				var newVelocity = _Utils_Tuple2(
					$elm$core$Basics$abs(
						$author$project$Vector$x(particle.q)),
					$author$project$Vector$y(particle.q));
				var newPosition = _Utils_Tuple2(
					$author$project$Box$min(box.s) + $author$project$Particle$radius(particle),
					$author$project$Vector$y(particle.n));
				return _Utils_update(
					particle,
					{n: newPosition, q: newVelocity});
...
var $author$project$Box$bounceY = F2(
	function (box, particle) {
		if (_Utils_cmp(
			$author$project$Vector$y(particle.n) + $author$project$Particle$radius(particle),
			$author$project$Box$max(box.w)) > 0) {
			var newVelocity = _Utils_Tuple2(
				$author$project$Vector$x(particle.q),
				-$elm$core$Basics$abs(
					$author$project$Vector$y(particle.q)));
			var newPosition = _Utils_Tuple2(
				$author$project$Vector$x(particle.n),
				$author$project$Box$max(box.w) - $author$project$Particle$radius(particle));
			return _Utils_update(
				particle,
				{n: newPosition, q: newVelocity});
		} else {
			if (_Utils_cmp(
				$author$project$Vector$y(particle.n) - $author$project$Particle$radius(particle),
				$author$project$Box$min(box.w)) < 0) {
				var newVelocity = _Utils_Tuple2(
					$author$project$Vector$x(particle.q),
					$elm$core$Basics$abs(
						$author$project$Vector$y(particle.q)));
				var newPosition = _Utils_Tuple2(
					$author$project$Vector$x(particle.n),
					$author$project$Box$min(box.w) + $author$project$Particle$radius(particle));
				return _Utils_update(
					particle,
					{n: newPosition, q: newVelocity});
			} else {
...
var $author$project$Particle$distance = F2(
	function (p, q) {
		return A2($author$project$Vector$distance, p.n, q.n);
	});
...
var $author$project$Particle$momentum = function (p) {
	return A2($author$project$Vector$multiply, p.i, p.q);
};
	...
	function (p, q) {
		...
		var qElasticity = A2(
			...
			A2(
				$author$project$Vector$multiply,
				p.i,
				A2($author$project$Vector$subtract, p.q, q.q)));
		var qVelocity = A2(
		...
		var pElasticity = A2(
			...
			A2(
				$author$project$Vector$multiply,
				q.i,
				A2($author$project$Vector$subtract, q.q, p.q)));
		var pVelocity = A2(
			$author$project$Vector$divide,
			p.i + q.i,
...
var $author$project$Particle$sigCollision = F2(
	function (p, q) {
		...
		var newP = _v0.a;
		var newQ = _v0.b;
		return A2($author$project$Vector$equivalent, p.q, newP.q) ? false : true;
	});
...
var $author$project$Particle$Particle = F4(
	function (position, velocity, acceleration, mass) {
		return {Y: acceleration, i: mass, n: position, q: velocity};
	});
var $author$project$Particle$merge = F2(
	function (p, q) {
		...
		var newPosition = A2(
			...
			A2(
				$author$project$Vector$add,
				A2($author$project$Vector$multiply, p.i, p.n),
				A2($author$project$Vector$multiply, q.i, q.n)));
		var newVelocity = A2(
			$author$project$Vector$divide,
			newMass,
			A2(
...
var $author$project$Contact$randomAcceleration = A3(
	$elm$random$Random$map2,
	$author$project$Vector$vector,
	A2($elm$random$Random$float, 0, 0),
	A2($elm$random$Random$float, 0, 0));
var $author$project$Contact$randomMass = function (box) {
	return A2(
		...
		A2(
			...
			2,
			$author$project$Box$max(box.s) / 100));
};
...
var $author$project$Contact$randomPosition = function (model) {
	return A3(
		$elm$random$Random$map2,
		$author$project$Vector$vector,
		A2(
			$elm$random$Random$float,
			$author$project$Box$max(model.e.s) * 0,
			$author$project$Box$max(model.e.s) * 1),
		A2(
			$elm$random$Random$float,
			$author$project$Box$max(model.e.w) * 0,
			$author$project$Box$max(model.e.w) * 1));
};
var $author$project$Contact$randomVelocity = function (model) {
	var vy = 2.0e-5 * $author$project$Box$max(model.e.w);
	var vx = 2.0e-5 * $author$project$Box$max(model.e.s);
	return A3(
		$elm$random$Random$map2,
		$author$project$Vector$vector,
...
var $author$project$Contact$newParticle = function (model) {
	return A4(
		$author$project$Particle$randomParticle,
		$author$project$Contact$randomPosition(model),
		$author$project$Contact$randomVelocity(model),
		$author$project$Contact$randomAcceleration,
		$author$project$Contact$randomMass(model.e));
};
var $author$project$Contact$newParticles = F2(
	function (model, n) {
		return A2(
			$elm$random$Random$list,
			n,
			$author$project$Contact$newParticle(model));
	});
		...
		return _Utils_update(
			p,
			{
				n: A2(
					$author$project$Vector$add,
					p.n,
					A2($author$project$Vector$multiply, dt, p.q))
			});
	});
		...
		var acceleration = F2(
			function (p, q) {
				var r = $author$project$Vector$normalize(
					A2($author$project$Vector$subtract, q.n, p.n));
				var dist = A2(
					$elm$core$Basics$max,
					A2($author$project$Particle$distance, p, q),
					$author$project$Particle$radius(p) + $author$project$Particle$radius(q));
				var k = (g * q.i) / A2($elm$core$Basics$pow, dist, 2);
...
var $author$project$Box$updateBox = F2(
	function (box, _v0) {
		...
		return A2(
			$author$project$Box$Box,
			_Utils_Tuple2(
				$author$project$Box$min(box.s),
				x),
			_Utils_Tuple2(
				$author$project$Box$min(box.w),
				y));
	});
		...
		return _Utils_update(
			p,
			{
				q: A2(
					$author$project$Vector$add,
					p.q,
					A2($author$project$Vector$multiply, dt, p.Y))
			});
	});
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$Contact$NewParticles,
						A2($author$project$Contact$newParticles, model, n)));
			case 1:
				var particles = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
					...
					_Utils_update(
						model,
						{
							e: A2(
								...
								model.e,
								_Utils_Tuple2(windowSize.w, windowSize.s)),
							z: _List_Nil
						}),
					A2(
						$elm$random$Random$generate,
...
var $author$project$Contact$svgAttributes = function (model) {
	return _List_fromArray(
		[
			...
			$elm$core$String$fromFloat(
				$author$project$Box$max(model.e.s))),
			A2(
			$elm$html$Html$Attributes$style,
			'height',
			$elm$core$String$fromFloat(
				$author$project$Box$max(model.e.w))),
...
var $author$project$Contact$svgElements = function (model) {
	var fillColor = 'black';
	var content = A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('phone')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fas fa-phone fa-8x'),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('email')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fas fa-envelope fa-8x'),
														A2($elm$html$Html$Attributes$style, 'color', 'black')
													]),
												_List_Nil)
											]))
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('https://twitter.com/eransomk')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fab fa-twitter fa-8x'),
														A2($elm$html$Html$Attributes$style, 'color', 'black')
													]),
												_List_Nil)
											]))
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$href('https://github.com/erickramer')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('fab fa-github fa-8x'),
														A2($elm$html$Html$Attributes$style, 'color', 'black')
													]),
												_List_Nil)
											]))
...
var $author$project$Contact$svg = function (model) {
	return A2(
		$elm$svg$Svg$svg,
		$author$project$Contact$svgAttributes(model),
		$author$project$Contact$svgElements(model));
};
var $author$project$Contact$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Contact$svg(model)
			]));
};
var $author$project$Contact$main = $elm$browser$Browser$element(
	{a8: $author$project$Contact$init, bp: $author$project$Contact$subscriptions, bt: $author$project$Contact$update, bu: $author$project$Contact$view});
_Platform_export({'Contact':{'init':$author$project$Contact$main(
