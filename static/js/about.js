...
var $author$project$About$randomPosition = function (model) {
	return A3(
		...
		A2(
			$elm$random$Random$float,
			$author$project$Box$max(model.e.r) * 0,
			$author$project$Box$max(model.e.r) * 1),
		A2(
			$elm$random$Random$float,
...
var $author$project$About$randomVelocity = function (model) {
	var vy = 2.0e-5 * $author$project$Box$max(model.e.s);
	var vx = 2.0e-5 * $author$project$Box$max(model.e.r);
	return A3(
		$elm$random$Random$map2,
		$author$project$Vector$vector,
					...
					_Utils_update(
						model,
						{
							e: A2(
								...
								model.e,
								_Utils_Tuple2(windowSize.s, windowSize.r)),
							z: _List_Nil
						}),
					A2(
						$elm$random$Random$generate,
	...
	return _List_fromArray(
		[
			...
			$elm$core$String$fromFloat(
				$author$project$Box$max(model.e.r))),
			A2(
			$elm$html$Html$Attributes$style,
			'height',
			$elm$core$String$fromFloat(
