...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { a5: 'hidden', aY: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { a5: 'mozHidden', aY: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { a5: 'msHidden', aY: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { a5: 'webkitHidden', aY: 'webkitvisibilitychange' }
		: { a5: 'hidden', aY: 'visibilitychange' };
}
...
var $author$project$Box$Box = F2(
	function (height, width) {
		return {X: height, ah: width};
	});
var $author$project$ParticlePage$Model = F3(
	function (box, particles, g) {
		return {al: box, W: g, bm: particles};
	});
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$ParticlePage$initModel = A3(
	$author$project$ParticlePage$Model,
	A2(
...
var $author$project$ParticlePage$init = function (_v0) {
	return _Utils_Tuple2($author$project$ParticlePage$initModel, $elm$core$Platform$Cmd$none);
};
...
var $author$project$ParticlePage$NewWindowSize = function (a) {
	return {$: 3, a: a};
};
var $author$project$ParticlePage$OnAnimate = function (a) {
	return {$: 0, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {aa: oldTime, aJ: request, aQ: subs};
	});
...
var $author$project$ParticlePage$subscriptions = F2(
	function (windowSizePort, model) {
		return $elm$core$Platform$Sub$batch(
			_List_fromArray(
				[
					$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$ParticlePage$OnAnimate),
					windowSizePort($author$project$ParticlePage$NewWindowSize)
				]));
	});
var $author$project$ParticlePage$NewParticles = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Particle$radius = function (p) {
	return $elm$core$Basics$sqrt(p.h);
};
...
var $author$project$Box$bounceX = F2(
	function (box, particle) {
		if (_Utils_cmp(
			...
			$author$project$Box$max(box.ah)) > 0) {
			...
			var newPosition = _Utils_Tuple2(
				$author$project$Box$max(box.ah) - $author$project$Particle$radius(particle),
			...
			if (_Utils_cmp(
				$author$project$Vector$x(particle.m) - $author$project$Particle$radius(particle),
				$author$project$Box$min(box.ah)) < 0) {
				var newVelocity = _Utils_Tuple2(
					$elm$core$Basics$abs(
						$author$project$Vector$x(particle.p)),
					$author$project$Vector$y(particle.p));
				var newPosition = _Utils_Tuple2(
					$author$project$Box$min(box.ah) + $author$project$Particle$radius(particle),
					$author$project$Vector$y(particle.m));
				return _Utils_update(
					particle,
					{m: newPosition, p: newVelocity});
...
var $author$project$Box$bounceY = F2(
	function (box, particle) {
		if (_Utils_cmp(
			...
			$author$project$Box$max(box.X)) > 0) {
			var newVelocity = _Utils_Tuple2(
				$author$project$Vector$x(particle.p),
				-$elm$core$Basics$abs(
					$author$project$Vector$y(particle.p)));
			var newPosition = _Utils_Tuple2(
				...
				$author$project$Box$max(box.X) - $author$project$Particle$radius(particle));
			return _Utils_update(
				particle,
				{m: newPosition, p: newVelocity});
		} else {
			if (_Utils_cmp(
				$author$project$Vector$y(particle.m) - $author$project$Particle$radius(particle),
				$author$project$Box$min(box.X)) < 0) {
				var newVelocity = _Utils_Tuple2(
					$author$project$Vector$x(particle.p),
					$elm$core$Basics$abs(
						$author$project$Vector$y(particle.p)));
				var newPosition = _Utils_Tuple2(
					$author$project$Vector$x(particle.m),
					$author$project$Box$min(box.X) + $author$project$Particle$radius(particle));
				return _Utils_update(
					particle,
					{m: newPosition, p: newVelocity});
			} else {
...
var $author$project$Particle$momentum = function (p) {
	return A2($author$project$Vector$multiply, p.h, p.p);
};
...
var $author$project$Particle$Particle = F4(
	function (position, velocity, acceleration, mass) {
		return {U: acceleration, h: mass, m: position, p: velocity};
	});
var $author$project$Particle$merge = F2(
	function (p, q) {
		...
		var newPosition = A2(
			...
			A2(
				$author$project$Vector$add,
				A2($author$project$Vector$multiply, p.h, p.m),
				A2($author$project$Vector$multiply, q.h, q.m)));
		var newVelocity = A2(
			$author$project$Vector$divide,
			newMass,
			A2(
...
var $author$project$ParticlePage$randomAcceleration = A3(
	$elm$random$Random$map2,
	$author$project$Vector$vector,
	A2($elm$random$Random$float, 0, 0),
	A2($elm$random$Random$float, 0, 0));
var $author$project$ParticlePage$randomMass = function (box) {
	return A2(
		...
		A2(
			...
			2,
			$author$project$Box$max(box.ah) / 100));
};
...
var $author$project$ParticlePage$randomPosition = function (model) {
	return A3(
		$elm$random$Random$map2,
		$author$project$Vector$vector,
		A2(
			$elm$random$Random$float,
			$author$project$Box$max(model.al.ah) * 0,
			$author$project$Box$max(model.al.ah) * 1),
		A2(
			$elm$random$Random$float,
			$author$project$Box$max(model.al.X) * 0,
			$author$project$Box$max(model.al.X) * 1));
};
var $author$project$ParticlePage$randomVelocity = function (model) {
	var vy = 2.0e-5 * $author$project$Box$max(model.al.X);
	var vx = 2.0e-5 * $author$project$Box$max(model.al.ah);
	return A3(
		$elm$random$Random$map2,
		$author$project$Vector$vector,
...
var $author$project$ParticlePage$newParticle = function (model) {
	return A4(
		$author$project$Particle$randomParticle,
		$author$project$ParticlePage$randomPosition(model),
		$author$project$ParticlePage$randomVelocity(model),
		$author$project$ParticlePage$randomAcceleration,
		$author$project$ParticlePage$randomMass(model.al));
};
var $author$project$ParticlePage$newParticles = F2(
	function (model, n) {
		return A2(
			$elm$random$Random$list,
			n,
			$author$project$ParticlePage$newParticle(model));
	});
	...
	function (g, particles) {
		var acceleration = F2(
			function (p, q) {
				...
				var k = (g * q.h) / A2($elm$core$Basics$pow, dist, 2);
...
var $author$project$Box$updateBox = F2(
	function (box, _v0) {
		...
		return A2(
			$author$project$Box$Box,
			_Utils_Tuple2(
				$author$project$Box$min(box.ah),
				x),
			_Utils_Tuple2(
				$author$project$Box$min(box.X),
				y));
	});
		...
		return _Utils_update(
			p,
			{
				p: A2(
					$author$project$Vector$add,
					p.p,
					A2($author$project$Vector$multiply, dt, p.U))
			});
	});
var $author$project$ParticlePage$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var dt = msg.a;
				...
				var particles = (dt < 150) ? A2(
					...
					A2(
						...
						collisionHandler(
							A2(
								$elm$core$List$map,
								$author$project$Box$bounce(model.al),
								A2(
									$elm$core$List$map,
			...
			case 2:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$ParticlePage$NewParticles,
						A2($author$project$ParticlePage$newParticles, model, n)));
			case 1:
				var particles = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
				...
				var updated = _Utils_update(
					model,
					{
						al: A2(
							...
							model.al,
							_Utils_Tuple2(windowSize.X, windowSize.ah)),
						bm: _List_Nil
					});
				return _Utils_Tuple2(
					updated,
					A2(
						$elm$random$Random$generate,
						$author$project$ParticlePage$NewParticles,
						A2($author$project$ParticlePage$newParticles, updated, 40)));
		}
	});
...
var $author$project$ParticlePage$svgAttributes = function (model) {
	return _List_fromArray(
		[
			...
			$elm$core$String$fromFloat(
				$author$project$Box$max(model.al.ah))),
			A2(
			$elm$html$Html$Attributes$style,
			'height',
			$elm$core$String$fromFloat(
				$author$project$Box$max(model.al.X))),
			A2($elm$html$Html$Attributes$style, 'background', 'white')
		]);
};
var $author$project$ParticlePage$svg = F2(
	function (model, elements) {
		return A2(
			$elm$svg$Svg$svg,
			$author$project$ParticlePage$svgAttributes(model),
			elements);
	});
...
var $author$project$About$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$author$project$ParticlePage$svg,
				model,
...
var $author$project$About$main = $elm$browser$Browser$element(
	{
		a7: $author$project$ParticlePage$init,
		bp: $author$project$ParticlePage$subscriptions($author$project$About$newWindowSize),
		bt: $author$project$ParticlePage$update,
		bu: $author$project$About$view
	});
